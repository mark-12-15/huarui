...
void BCMRoom::onLoopWindowScene()
{
    ...
    BCMGroupScene *pGroupScene = m_lstGroupScene.first();
                              ...
                              int type, const QString &cmdon, const QString &cmdoff, bool bSendCmd)
{
    ...
    BCLocalServer::Application()->UpdateRoomSwitchConfig(this);
}
